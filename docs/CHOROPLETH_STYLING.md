...
- [ ] Legend values match data ranges
- [ ] Hover states work smoothly
- [ ] No visual artifacts at polygon boundaries
- [ ] Colors distinguishable at different zoom levels
- [ ] Accessible contrast ratios (WCAG AA)
- [ ] Print preview looks good (if applicable)
